 ...
 */
final class Version20201117162643 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE artiste ADD image_work_one VARCHAR(255) NOT NULL, ADD title_work_one VARCHAR(255) NOT NULL, ADD year_work_one DATETIME NOT NULL, ADD price_one INT NOT NULL, ADD introduction_work_one LONGTEXT NOT NULL, ADD material_one VARCHAR(255) NOT NULL, ADD dimension_one VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE artiste DROP image_work_one, DROP title_work_one, DROP year_work_one, DROP price_one, DROP introduction_work_one, DROP material_one, DROP dimension_one');
    }
}
